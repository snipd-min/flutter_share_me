...
public class FlutterShareMePlugin implements MethodCallHandler, FlutterPlugin, ActivityAware {
  ...
  public void onMethodCall(MethodCall call, @NonNull Result result) {
    String url, msg, fileType, filePath;
    switch (call.method) {
      ...
      case _methodTwitter:
        ...
        shareToTwitter(url, msg, filePath, result);
        break;
  ...
  private void shareToTwitter(String url, String msg, String filePath, Result result) {
    try {
